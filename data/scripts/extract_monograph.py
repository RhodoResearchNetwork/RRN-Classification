...
scientificnameauthorship: "{{ scientificnnameauthor }}"
genus: "{{ genus }}"
subfamily: "{{ subfamily }}"
section: "{{ section }}"
...
namepublishedin: "{{ primary_reference }}"
doi: "{{ doi }}"
wfo_id : "{{ taxonid }}"
wfo_parent_id: "{{ parent_id }}"
wfo_accepted_id: "{{ accepted_id }}" #if synonym probably needs to be archived.                      
ipni_id: "{{ ipni_id }}"
verified:
---
...
if __name__ == "__main__":
    main("data\EdinburghMonograph\edinburgh_monograph.xml")